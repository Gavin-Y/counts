...
//        lfAdapter.notifyDataSetChanged();
    ...
    private void initWithContext(Context context) {
        ...
        mHeaderTimeView = (TextView) recyclerViewHeader
                .findViewById(me.leefeng.lfrecyclerview.R.id.lfrecyclerview_header_time);
        mHeaderViewContent = (RelativeLayout) recyclerViewHeader
                .findViewById(me.leefeng.lfrecyclerview.R.id.lfrecyclerview_header_content);
...
//            super.onItemRangeMoved(fromPosition + lfAdapter.getheaderViewCount(), toPosition + lfAdapter.getheaderViewCount(), itemCount);
    ...
    public void setFootTextColor(int color){
        recyclerViewFooter.getmHintView().setTextColor(color);
    }

    public TextView getFootText(){
        return recyclerViewFooter.getmHintView();
    }
    ...
    public void setRecyclerViewHeaderColor(int color) {
        recyclerViewHeader.getmContainer().setBackgroundColor(color);
    }
}
